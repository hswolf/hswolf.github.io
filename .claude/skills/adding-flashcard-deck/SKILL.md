...
The flashcard experience lives at `/japanese/flashcards` and is powered by a React island (`src/components/flashcards/Flashcards.tsx`) hydrated on per-deck Astro pages. A "deck" is a typed TS file plus a folder of images. Current repo ships nine decks: `n5-lesson12-c` (39 cards, fully imaged), `n5-lesson15-1` (21 cards), `n5-lesson15-6` (25 cards), `n5-lesson16` (39 cards, no images yet), `n5-lesson17` (34 cards, no images yet), `n5-lesson18` (46 cards, no images yet), `n5-lesson19` (46 cards, no images yet), `n5-lesson20` (42 cards combining A + B, no images yet), `n5-lesson20-c` (19 cards, no images yet). The routing is multi-deck: `/japanese/flashcards` is a deck index, `/japanese/flashcards/<slug>` mounts the island for one deck. This skill covers how to add another deck, edit an existing one, or touch the supporting machinery without breaking the mobile polish and review-mode state machinery that already landed.
